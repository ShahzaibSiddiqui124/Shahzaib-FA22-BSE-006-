  ...
  const applyFilter = () => {
    if (speciality) {
      ...
      const filtered = doctors.filter(doc => 
        // --- FIXED: Changed 'specialization' to 'speciality' ---
        doc.speciality && doc.speciality.toLowerCase().trim() === decodedSpeciality.toLowerCase().trim()
      )
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          {/* FIXED: Updated 'Pediatrician' to 'Pediatricians' to match Database Value */}
