    ...
    const getAvailableSolts = async () => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            while (currentDate < endTime) {
                ...
                // Check if slots_booked exists before accessing it
    ...
    const bookAppointment = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/user/book-appointment', { 
                ...
                slotTime,
                userId: userData._id,
                amount: docInfo.fees // <--- FIXED: Used correct DB key 'fees'
    ...
    return docInfo ? (
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                <div>
                    {/* The image src is already a full URL from the backend, so we use it directly */}
                ...
                <div className='flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    ...
                    <div className='flex items-center gap-2 mt-1 text-gray-600'>
                        {/* FIXED: Changed back to 'speciality' to match Database */}
            ...
            {/* FIXED: Changed back to 'speciality' */}
