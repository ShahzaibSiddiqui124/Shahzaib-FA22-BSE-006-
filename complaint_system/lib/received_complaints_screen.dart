...
class ReceivedComplaintsScreen extends StatefulWidget {
  final AppUser user;

  const ReceivedComplaintsScreen({super.key, required this.user});

  @override
  State<ReceivedComplaintsScreen> createState() => _ReceivedComplaintsScreenState();
}

class _ReceivedComplaintsScreenState extends State<ReceivedComplaintsScreen> {
  ...
  Future<void> _loadComplaints() async {
    ...
    try {
      final complaints = await ComplaintService.getReceivedComplaints(widget.user.id);
      setState(() {
  ...
  Future<void> _updateComplaintStatus(Complaint complaint, ComplaintStatus newStatus) async {
    try {
      final success = await ComplaintService.updateComplaintStatus(
